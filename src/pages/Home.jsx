  ...
  return (
    <>
      <div
        ...
        id="home"
      >
        <div className="w-full flex sm:flex-row flex-col-reverse sm:justify-center items-center gap-5 sm:gap-20">
          <div className="dark:text-slate-300 flex flex-col text-3xl my-4 sm:w-1/2 w-3/4">
            ...
            <span
              ref={el}
              className="font-semibold text-3xl md:text-4xl text-wrap"
            ></span>
            <br />
